...
FCF_FG_4BIT = 0x0000000000000001  # = FCF_FG_INDEX
FCF_BG_4BIT = 0x0000000000000002  # = FCF_BG_INDEX
FCF_4BITMASK = 0x000000000000000B  # = FCF_INDEXMASK
FCF_RAWATTR_MASK = 0x000000000000FF00
FCF_FG_BOLD = 0x1000000000000000
FCF_FG_ITALIC = 0x2000000000000000
FCF_FG_U_DATA0 = 0x4000000000000000  # underline style storage (single, double, curly, dot, dash)
FCF_FG_U_DATA1 = 0x8000000000000000
FCF_FG_OVERLINE = 0x0100000000000000
FCF_FG_STRIKEOUT = 0x0200000000000000
FCF_FG_FAINT = 0x0400000000000000
FCF_FG_BLINK = 0x0800000000000000
FCF_INVERSE = 0x0010000000000000
FCF_FG_INVISIBLE = 0x0020000000000000
FCF_FG_U_DATA2 = 0x0040000000000000
FCF_FG_UNDERLINE_MASK = 0xC040000000000000  # FCF_FG_U_DATA0 | FCF_FG_U_DATA1 | FCF_FG_U_DATA2
FCF_STYLE_MASK = 0xFFF0000000000000
FCF_FG_UNDERLINE = 0x4000000000000000  # alias for FCF_FG_U_DATA0
FCF_NONE = 0

# UNDERLINE_STYLE - underline style values decoded from FCF_FG_U_DATA0/1/2 bits
UNDERLINE_NONE = 0
UNDERLINE_SINGLE = 1
UNDERLINE_DOUBLE = 2
UNDERLINE_CURLY = 3
...
# MENUITEMFLAGS - flags for FarMenuItem
MIF_SELECTED = 0x0000000000010000
MIF_CHECKED = 0x0000000000020000
MIF_SEPARATOR = 0x0000000000040000
MIF_DISABLE = 0x0000000000080000
MIF_GRAYED = 0x0000000000100000
MIF_HIDDEN = 0x0000000000200000
MIF_NONE = 0
...
# FARCHECKEDSTATE - checkbox/radio button state
BSTATE_UNCHECKED = 0
BSTATE_CHECKED = 1
BSTATE_3STATE = 2
BSTATE_TOGGLE = 3
...
DM_SETDIALOGPOS = 60
DM_LISTGETDATASIZE = 61
DM_GETSELECTION = 62
DM_SETSELECTION = 63
DM_GETEDITPOSITION = 64
DM_SETEDITPOSITION = 65
DM_SETCOMBOBOXEVENT = 66
DM_GETCOMBOBOXEVENT = 67
DM_GETCONSTTEXTPTR = 68
DM_GETDLGITEMSHORT = 69
DM_SETDLGITEMSHORT = 70
DM_GETDIALOGINFO = 71
DM_GETDIALOGTITLE = 72
DM_USER = 0x4000
...
# FARLISTINFOFLAGS - flags for FarListInfo
...
class FarListInfo(ctypes.Structure):
    _fields_ = [
        ("StructSize", size_t),
        ("Flags", ctypes.c_ulonglong),  # FARLISTINFOFLAGS
        ("ItemsNumber", size_t),
        ("SelectPos", intptr_t),
        ("TopPos", intptr_t),
        ("MaxHeight", intptr_t),
...
# FARDIALOGFLAGS - flags for DialogInit
...
EF_IMMEDIATERETURN = 0x0000000000000020
...
# Palette Colors (from farcolor.hpp - Far 3.0.6698.0)
COL_MENUTEXT = 0
...
# EDITOR_CURRENTSTATE
ECSTATE_MODIFIED = 0x0000000000000001
ECSTATE_SAVED = 0x0000000000000002
ECSTATE_LOCKED = 0x0000000000000004
...
EOPT_CHARCODEBASETYPE = 0x00000010
EOPT_CHARCODEBASECLASS = 0x00000020
EOPT_CURSORBEYONDEOL = 0x00000040
EOPT_SHOWWHITESPACE = 0x00000080
EOPT_SHOWLINEBREAK = 0x00000100
EOPT_PERSISTENTSORT = 0x00000200
EOPT_TABTOSPACES = 0x00000400
EOPT_DOUBLECLICKLINENUMBER = 0x00000800
EOPT_SHOWLINENUMBERS = 0x00001000
...
# OPERATION_MODES - flags for operation context
